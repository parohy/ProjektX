...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2015 at 11:52 AM
...
(2, 6, 0, 'LENOVO IDEAPAD G50-30 N3540 15.6" W8.1 STRIEBORNÝ (80G001U7CK)', 399.99, 'LENOVO', 'Ak si chcete prácu či zábavu naozaj vychutnať, neváhajte siahnuť po praktickom notebooku LENOVO IdeaPad G50-30 N3540 15.6" W8.1 s množstvom praktických konektorov. Integrovaný operačný systém Windows 8.1 je len základom úspechu a výborného výkonu celého zariadenia. Samozrejmosťou je kapacita 1 TB pre rozličný multimediálny obsah, integrovaná HD web kamera a prácu vám uľahčí aj vhodne ergonomicky tvarovaná klávesnica a viacdotykový touchpad optimalizovaný pre prácu s operačným systémom. Každodenná práca i zábava na tomto notebooku sa pre vás stane príťažlivým okamihom!', 1, '..\\img\\products\\2\\236806.jpg'),
