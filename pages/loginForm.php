...
<form action="API/Relog.php?register=login" method="POST">
    <ul class="login-container">
        ...
        <li class="login-item"><input type="email" name="usermail" placeholder="Email..." maxlength="40" id="mail-input" required><span id="mail-error"></span></li>
        <li class="login-item"><label for="usermail">Password:</label></li>
        <li class="login-item"><input type="password" name="password" placeholder="Pasword..." maxlength="30" id="password-input" required><span id="pass-error"></span></li>
